...
# Wit.ai parameters
WIT_TOKEN = os.environ.get('TY53WNVQUULTRM7TFZR3RNAIK42IYT6G')
# Messenger API parameters
FB_PAGE_TOKEN = os.environ.get('EAACtPl97H00BAMasniM81hRxHhe5i90EsyfSjRQZCEbuleQM61OWODK9kb28sPN3CX3oceu1M8mVYZCjaTKBfNQuqEbMLJR1m4SGvIluuv1TJC8VROZCZAb2JgTZCNbtx4iEHBhPtV4DYEnT9FKYD6OL8KFQchw5EqWfabfyNBgZDZD')
# A user secret to verify webhook get request.
FB_VERIFY_TOKEN = os.environ.get('')
